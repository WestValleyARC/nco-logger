...
export declare const QRZ_NAME_FRESH_TTL_MS: number;
...
export declare const isQrzNameFresh: (outcome: string, nameVersion: unknown, requiredNameVersion: number, checkedAt: unknown, now?: number) => boolean;
