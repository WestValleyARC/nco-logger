...
- Key `data-` attributes commonly used by client code:
    ...
    - data-log-level, data-ts, data-chat
...
- `immer` is vendored locally and resolved via the import map in `head.ejs`.
...
- [Chat System](chat-system.md) — local MongoDB/SSE integration details
